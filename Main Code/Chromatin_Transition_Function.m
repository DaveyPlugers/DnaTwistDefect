...
k = Start_Position; %what position does our simulation start at
...
while Looping
    ...
    if Time > Duration
       ...
       k = k - sum(Defect_Array)*(-1)^(Chr_Dir); %We undo the still present defects, we can make this more accurate later
